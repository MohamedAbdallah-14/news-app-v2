...
import 'package:news_app/core/data/api_manager/status_checker/error_status.dart';
...
void main() {
  group(
    'Status checker HTTPCodes',
    () {
      test(
        'should return HTTPCode enum Success if called with 200',
        () async {
          // arrange
      ...
      test(
        'should return HTTPCode enum error if called with 400',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
      ...
      test(
        'should return HTTPCode enum invaildToken if called with 406',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
          ...
          // assert
          expect(code, HTTPCodes.invalidToken);
        },
      );

      test(
        'should return HTTPCode enum serviceNotAvailable if called with 500',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
      ...
      test(
        'should return HTTPCode enum unknown if called with 800',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
  ...
  group(
    'Status checker ErrorStatus',
    () {
      test(
        'should return ErrorStatus enum validationError if called with 400',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
      ...
      test(
        'should return ErrorStatus enum validationError if called with 401',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
      ...
      test(
        'should return ErrorStatus enum validationError if called with 403',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
      ...
      test(
        'should return ErrorStatus enum validationError if called with 410',
        () async {
          // arrange
          final statusChecker = StatusChecker();
          // act
